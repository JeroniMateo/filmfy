<template>
  <div class="">
    <div class="">
      ...
      <div class="panel">
        <p id="runtime">
          <span>Duracion : </span>{{ this.movie.runtime }} minutos
        </p>
      </div>
      <div class="panel">
...
export default {
  ...
  methods: {
    infoOutput () {
      ...
      const writters = document.getElementById('writters')
      ...
      const release_date = (document.getElementById(
        'release_date'
      ).innerHTML += `${toMonthName(
        date.getMonth()
      )} de ${date.getFullYear()} `)
    }
  }
