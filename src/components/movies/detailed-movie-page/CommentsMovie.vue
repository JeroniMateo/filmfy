<template>
  ...
  <li  class="comment d-flex flex-row row">
    <div class="col-2">
    ...
    <div class="d-flex flex-column justify-content-end col-2">
...
export default {
  ...
  methods: {
    ...
    async sendLike(id) {
      let promise = await fetch(`http://127.0.0.1:8000/api/comment-like/${id}`)
      location.reload()
    }
  }
}
