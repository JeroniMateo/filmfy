<template>
  <div class="container">
    <!--Card1-->
    <div class="card mb-3 container" id="welcomeCard">
      <div class="row g-0">
        <div class="col-md-4">
          <img
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <p class="card-text">
              Almacena tu mejor contenido <br />
              y disfrutalo junto a tus amigos
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row g-0">
        <div class="col-md-8">
          <div class="card-body">
            ...
            <p class="card-text">
              Estate en todos los debates y demuestra y ponte a prueba <br />
              sobre tus conocimientos e intereses por todo tipo de conenido
            </p>
          </div>
        </div>
        <div class="col-md-4">
