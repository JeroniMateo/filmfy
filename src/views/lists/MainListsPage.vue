  ...
  <main class="bg-bgmain">
    <div class="container-md">
      <div class="heading image d-flex justify-content-end flex-column">
        <div
          class="container text-movie d-flex flex-column justify-content-center"
        >
          <span><strong>Colecciona, selecciona y comparte.</strong></span>
          <span
            ><strong
              >Las listas de Filmfy son la forma perfecta de tener tus
              películas.</strong
            ></span
          >
        </div>
      ...
      <section class="month-popular">
        ...
        <div class="mt-3 row">
          <div
            ...
            v-for="list in listsMostLiked.slice(0, 3)"
          >
            <a
        ...
        <section class="recently-liked col-xxl-6 col-12">
          ...
          <div>
            <div
              ...
              v-for="list in listsRecent.slice(0, 5)"
            >
              <div class="list d-flex row">
                ...
                <div class="list-details d-flex flex-column col-5">
                  <div
                    class="list-title d-flex flex-row justify-content-start m-1"
                  >
                    <span style="text-align: left">{{ list.l_title }}</span>
                  </div>
                  <div
                    class="list-description d-flex flex-row justify-content-start m-1"
                  >
                    <span style="text-align: left">{{
                      list.l_description
                    }}</span>
